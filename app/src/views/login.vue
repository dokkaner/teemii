<template>
    <div class="flex min-h-screen items-center justify-center bg-main-50 px-4 py-12 sm:px-6 lg:px-8">
      <div class="w-full max-w-md space-y-8">
        <div>
          <img class="mx-auto h-12 w-auto" src="/assets/icons/logo.png" alt="Teemii" />
          <h2 class="mt-6 text-center text-3xl font-extrabold text-main-900">Sign in</h2>
        </div>
        ...
        <form class="mt-8 space-y-6" @submit.prevent="validateBeforeSubmit">
          ...
          <div class="-space-y-px rounded-md shadow-sm">
            ...
            <div>
              ...
              />
              <span class="absolute inset-y-0 end-0 z-10 grid place-content-center px-4"  @click="isShowPassword = !isShowPassword">
          ...
          <div>
            <button type="submit" class="group relative flex w-full justify-center rounded-md border border-transparent bg-main-600 px-4 py-2 text-sm font-medium text-white hover:bg-main-700 focus:outline-none focus:ring-2 focus:ring-main-500 focus:ring-offset-2">
            <span class="absolute inset-y-0 left-0 flex items-center pl-3">
              <LockClosedIcon class="h-5 w-5 text-main-500 group-hover:text-main-400" aria-hidden="true" />
            </span>
              Sign in
            </button>
          </div>
