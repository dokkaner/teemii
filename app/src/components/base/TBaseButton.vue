<template>
  <button type="button"
    ...
    <svg v-if="contentLoading" class="-ml-1 mr-3 h-5 w-5 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
const variantClass = computed(() => {
  return {
    'text-white border border-transparent bg-accent-500 hover:bg-accent-700 focus:outline-none focus:ring-2 focus:ring-accent-500 focus:ring-offset-2':
        props.variant === 'primary',
    'text-main-700 border border-light-600 bg-light-300 hover:bg-light-600 focus:outline-none focus:ring-2 focus:ring-light-500 focus:ring-offset-2':
