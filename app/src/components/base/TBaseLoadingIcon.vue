<template>
  <span>
    ...
    <span v-if="loading > 0" class="inline-flex" data-tip="Downloading">
      <TBaseRadialProgress class="top-0.5" :completed-steps="loading" :diameter="12" :strokeWidth="2" :innerStrokeWidth="1"></TBaseRadialProgress>
    </span>
  </span>
  <div v-if="error" class="inline-flex text-red-500 mx-2">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 -6 24 28" stroke-width="1.0" stroke="currentColor" class="w-[14px] h-[14px]">
