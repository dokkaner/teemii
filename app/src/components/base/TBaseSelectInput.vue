<template>
  ...
  <Listbox v-else v-model="selectedValue" as="div" v-bind="$attrs">
    ...
    <div class="relative">
      <ListboxButton class="relative w-full cursor-default rounded-md border border-accent-200 bg-white py-2 pl-3 pr-10 text-left shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
...
function selectedLabel() {
  return this.getValue(this.selectedValue) || this.placeholder || 'Please select an option';
}
