  ...
  >
    <div class="flex justify-between flex-1 sm:hidden">
      <a
          href="#"
          :class="{
          'disabled cursor-normal pointer-events-none !bg-main-100 !text-main-400':
      ...
      <a
          href="#"
          :class="{
          'disabled cursor-default pointer-events-none !bg-main-100 !text-main-400':
        ...
        >
          ...
          <a
              ...
              'z-10 bg-primary-50 border-primary-500 text-primary-600':
                isActive(1),
              'bg-white border-main-300 text-main-500 hover:bg-main-50':
                !isActive(1),
            }"
              class="
              relative
