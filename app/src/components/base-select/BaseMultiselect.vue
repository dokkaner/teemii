  ...
  props: {
    ...
    classes: {
      ...
      default: () => ({
        ...
        optionSelected: 'text-main-800 font-bold bg-primary-500 dark:text-white dark:bg-darkMain-500',
        optionDisabled: 'text-accent-300 cursor-not-allowed dark:text-darkAccent-300',
        optionSelectedPointed: 'text-accent-800 font-bold bg-primary-500 opacity-90 dark:text-darkAccent-200 dark:bg-darkMain-500',
